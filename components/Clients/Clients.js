    ...
    <section className="max-w-[1320px]">
        <div className={styles.columns}>
            <div className={styles.logos}>
                <img className="mx-auto h-12" src="/logo1.png" alt="logo1" />
            </div>
            <div className={styles.logos}>
                <img className="mx-auto h-12" src="/logo2.png" alt="logo2" />
            </div>
            <div className={styles.logos}>
                <img className="mx-auto h-12" src="/logo3.png" alt="logo3" />
            </div>
            <div className={styles.logos}>
                <img className="mx-auto h-12" src="/logo4.png" alt="logo4" />
            </div>
        </div>
        <div className={styles.columns}>
            <div className={styles.logos}>
